...
`` Every Method here is based on solving linear equations or finding the inverse of a matrix A. These were some of my former homework assignments for the module Numerics I, provided for reference regarding the problem numbers.``
